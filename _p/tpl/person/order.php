			...
			<div class="userinfo">
				...
				?>
					<table class="table-orderList">
						<thead>
						<tr>
							<th colspan="5" style="background-color: #fff; text-align: left;">
								<a href="<?php echo _u('//order_view/'.$v['id'].'/'.Page::$p.'/'); ?>">#<?php echo $v['id']; ?>, ￥<?php echo _rmb($v['total']); ?>, <?php echo _time($v['addtime']); ?> [<?php echo $v['status']; ?>]</a>
