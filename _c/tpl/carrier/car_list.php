...
<div class="rightinfo">
    <div class="tools">
        <ul class="toolbar">
            <li class="click"><a href="<?php echo _u('//add_car/'._v(3).'/'._v(4).'/');?>"><span><img src="<?php echo _img('t01.png');?>" /></span>添加</a></li>
        </ul>
    </div>
    <table class="tablelist">
        ...
        foreach(Page::$arr as $k=>$v){
            ...
            <tr>
                ...
                <td><?php echo $v['ship_weight']; ?>kg</td>
                ...
                <td><a href="<?php echo _u('/carrier/edit_car/'.$v['id'].'/'._v(3).'/'._v(4).'/'); ?>" class="tablelink">编辑</a></td>
            </tr>
            <?php
        }
        ?>
