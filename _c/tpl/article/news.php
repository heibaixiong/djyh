...
<body>
    ...
    <div class="tools">    
        <ul class="toolbar">
        <li class="click"><a href="<?php echo _u('//newsadd/');?>"><span><img src="<?php echo _img('t01.png');?>" /></span>添加</a></li>
        </ul>
    </div>
    <table class="tablelist">
        ...
        <td><?php echo $_['state'][$v['state']]?> <a href="<?php echo _u('//newsstate/'.$v['id'].'/');?>" class="tablelink">改变状态</a></td>
        <td><?php echo $v['px']?></td>
        <td><a href="<?php echo _u('//newsedit/'.$v['id'].'/');?>" class="tablelink">编辑</a> <a href="<?php echo _u('//newsdel/'.$v['id'].'/');?>" class="tablelink">删除</a></td>
        </tr>
        <?php
        }
        ?>
