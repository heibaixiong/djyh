...
<body>
    ...
    <div class="formbody">    
    <div class="formtitle"><span>添加子参数</span></div>
    <form action="<?php echo _u('//add/');?>" method="post" id="form1">
        <ul class="forminfo">
        <li><label>子参数名称</label><input name="title" type="text" class="dfinput" /><input name="pid" type="hidden" class="dfinput" value="<?php echo _v(3);?>" /></li>
