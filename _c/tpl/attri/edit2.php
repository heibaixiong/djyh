...
<body>
    ...
    <div class="formbody">    
    <div class="formtitle"><span>编辑子属性</span></div>
    <form action="<?php echo _u('//edit/');?>" method="post" id="form1">
        <ul class="forminfo">
        <li><label>子属性名称</label><input name="title" type="text" class="dfinput" value="<?php echo $_['rs']['title'];?>" /><input name="pid" type="hidden" class="dfinput" value="<?php echo $_['rs']['pid'];?>" /><input type="hidden" value="<?php echo $_['rs']['id'];?>" name="id" /></li>
        <li><label>属性值</label><input name="content" type="text" class="dfinput" value="<?php echo $_['rs']['content'];?>" /><i>多个值用英文逗号隔开</i></li>
