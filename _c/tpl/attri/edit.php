...
<body>
    ...
    <div class="formbody">    
    <div class="formtitle"><span>编辑属性分类</span></div>
    <form action="<?php echo _u('//edit/');?>" method="post" id="form1">
        <ul class="forminfo">
        <li><label>属性分类名称</label><input name="title" type="text" class="dfinput" value="<?php echo $_['rs']['title'];?>" /><input type="hidden" value="<?php echo $_['rs']['id'];?>" name="id" /></li>
