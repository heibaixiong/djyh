...
<body style="background:#f0f9fd;">
    ...
    <dd>
    <div class="title">
    <span><img src="<?php echo _img('leftico01.png');?>" /></span>管理信息
    </div>
    	<ul class="menuson">
        <li>
            <div class="header">
    ...
    <dd>
    <div class="title">
    <span><img src="<?php echo _img('leftico01.png');?>" /></span>其他设置
    </div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="<?php echo _img('leftico01.png');?>" /></span>编辑器</div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="<?php echo _img('leftico01.png');?>" /></span>日期管理</div>
    <ul class="menuson">
        <li><cite></cite><a href="#">自定义</a><i></i></li>
        <li><cite></cite><a href="#">常用资料</a><i></i></li>
        <li><cite></cite><a href="#">信息列表</a><i></i></li>
