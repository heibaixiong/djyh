...
<div class="rightinfo">
    <div class="tools">
        <ul class="toolbar">
            ...
            <li class="click"><a href="<?php echo _u('//msg/'._v(3).'/'._v(4).'/');?>"><span><img src="<?php echo _img('t01.png');?>" /></span>消息</a></li>
        </ul>
    </div>
    <table class="tablelist">
        ...
        foreach(Page::$arr as $k=>$v){
            ...
            <tr>
                ...
                <td><a href="<?php echo _u('/work/edit/'.$v['id'].'/'); ?>" class="tablelink">编辑</a></td>
            </tr>
            <?php
        }
        ?>
