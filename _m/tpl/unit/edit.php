...
<body>
    ...
    <div class="formbody">    
    <div class="formtitle"><span>编辑单位</span></div>
    <form action="<?php echo _u('//edit/');?>" method="post" id="form1">
        <ul class="forminfo">
        <li><label>单位名称</label><input name="title" type="text" class="dfinput" value="<?php echo $_['rs']['title'];?>" /><input type="hidden" value="<?php echo $_['rs']['id'];?>" name="id" /></li>
        <li><label>备注</label><input name="content" type="text" class="dfinput" value="<?php echo $_['rs']['content'];?>" /></li>
