...
<body>
    ...
    <div class="formbody">    
    <div class="formtitle"><span>添加单位</span></div>
    <form action="<?php echo _u('//add/');?>" method="post" id="form1">
        <ul class="forminfo">
        <li><label>单位名称</label><input name="title" type="text" class="dfinput" /></li>
        <li><label>备注</label><input name="content" type="text" class="dfinput" /></li>
