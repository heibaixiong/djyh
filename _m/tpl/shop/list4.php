...
<body>
    ...
    <table class="tablelist">
        ...
        <tr>
        <td><?php echo $v['id'];?></td>
        <td><a href="<?php echo _u('p//show/'.$v['id'].'/');?>" target="_blank"><?php echo $v['title'];?></a></td>
        <td><?php echo $v['number'];?></td>
        <td>￥<?php echo _rmb($v['mark']/100);?></td>
        <td><?php echo $v['uname'];?></td>
        <td><?php echo $_['state'][$v['state']];?> <a href="<?php echo _u('//state/'._v(2).'/'.$v['id'].'/');?>" class="tablelink">改变状态</a></td>
        <td><?php echo $v['px']?></td>
