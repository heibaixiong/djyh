...
<body>
    ...
    <div id="usual1" class="usual">
        ...
        <div class="itab">
            ...
            <li style="margin-left:200px;"><input name="" id="btn" type="button" class="btn" value="确认添加" /></li>
            </ul>
        </div>        
            <div id="tab1" class="tabson">    
                    <ul class="forminfo">
                        ...
                        ?>
                        <li><label>商品主图<b>*</b></label><input name="img" type="text" class="dfinput" /><?php echo _upload('img','form1');?><i>图片为jpg格式的正方形</i></li>
                        <li><label>商品侧图1</label><input name="img1" type="text" class="dfinput" /><?php echo _upload('img1','form1');?><i>图片为jpg格式的正方形</i></li>
                        <li><label>商品侧图2</label><input name="img2" type="text" class="dfinput" /><?php echo _upload('img2','form1');?></li>
                        <li><label>商品侧图3</label><input name="img3" type="text" class="dfinput" /><?php echo _upload('img3','form1');?></li>
                        <li><label>商品侧图4</label><input name="img4" type="text" class="dfinput" /><?php echo _upload('img4','form1');?></li>
            ...
            <div id="tab3" class="tabson" style="display:none;">
                ...
                <div id="all" style="padding:5px 10px;border:#0f0 1px solid;">库存全部99</div>
            </div>
        </form>
    </div> 
    </div>
