...
<body>
    ...
    <div class="formbody">    
    <div class="formtitle"><span>编辑参数</span></div>
    <form action="<?php echo $_wrap['ctrl_url'].$_vew[1].'/edit';?>" method="post" id="form1">
        <ul class="forminfo">
        <li><label>参数名称</label><input name="title" type="text" class="dfinput" value="<?php echo $_['rs']['title'];?>" /><input type="hidden" value="<?php echo $_['rs']['id'];?>" name="id" /></li>
