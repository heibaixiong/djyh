...
<body style="background:url(<?php echo _img('topbg.gif');?>) repeat-x;">
    <div class="topleft">
    <a href="main.html" target="_parent"><img src="<?php echo _img('logo.png');?>" title="系统首页" /></a>
    </div>
    <ul class="nav">    
    <li><a href="<?php echo _u('/index/work/');?>" target="leftFrame"><img src="<?php echo _img('icon10.png');?>" title="工作台" /><h2>工作台</h2></a></li>
    <li><a href="<?php echo _u('/index/message/');?>" target="leftFrame"><img src="<?php echo _img('icon08.png');?>" title="在线留言" /><h2>在线留言</h2></a></li>
    <?php
    if(_session('adminrank')<5){
    ?>
    <li><a href="<?php echo _u('/index/order/');?>"  target="leftFrame"><img src="<?php echo _img('icon14.png');?>" title="订单管理" /><h2>订单管理</h2></a></li>
    ...
    ?>
    <li><a href="<?php echo _u('/index/user/');?>"  target="leftFrame"><img src="<?php echo _img('icon13.png');?>" title="会员管理" /><h2>区域/会员</h2></a></li>
    ...
    <li><a href="<?php echo _u('/index/config/');?>"  target="leftFrame"><img src="<?php echo _img('icon06.png');?>" title="系统设置" /><h2>系统设置</h2></a></li>
    <?php
    }
    ?>
    </ul>
